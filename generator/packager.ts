...
# For production, use Realm-scoped public keys or user authentication (JWT)
# This key should have LIMITED permissions (read/write only to this Realm)
VITE_UBL_API_KEY=your-realm-scoped-api-key-here
`,
  ...
  theme: {
    extend: {
      colors: {
        ...
        'surface-hover': '${this.addOpacity(theme.colors.surface, 0.8)}',
