...
export type LayoutType = 'dashboard' | 'chat-focus' | 'documentation' | 'workflow';

export const LAYOUTS: Record<LayoutType, string> = {
 ...
 */
export function selectLayout(templateId: string): LayoutType {
 ...
 */
export function getAllLayouts(): LayoutType[] {
